...
public class ProxyController {
    ...
    @Value("${BILLING_URL:http://localhost:8084}") String billing;
    ...
    @GetMapping("/billing/**")
    public ResponseEntity<String> billingProxy(){ return ResponseEntity.ok(rt.getForObject(billing + "/api/billing/hello", String.class)); }
}
